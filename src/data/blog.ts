...
export const blogTagTone: Record<string, string> = {
  "Node.js": "border-emerald-500/25 bg-emerald-500/10 text-emerald-400",
  TypeScript: "border-blue-500/25 bg-blue-500/10 text-blue-400",
  API: "border-purple-500/25 bg-purple-500/10 text-purple-400",
  React: "border-cyan-400/25 bg-cyan-400/10 text-cyan-300",
  "Next.js": "border-slate-400/25 bg-slate-400/10 text-slate-300",
  Performance: "border-amber-500/25 bg-amber-500/10 text-amber-400",
  PostgreSQL: "border-blue-400/25 bg-blue-400/10 text-blue-300",
  Backend: "border-purple-500/25 bg-purple-500/10 text-purple-400",
  Security: "border-rose-500/25 bg-rose-500/10 text-rose-400",
  JWT: "border-orange-500/25 bg-orange-500/10 text-orange-400",
  DevOps: "border-cyan-500/25 bg-cyan-500/10 text-cyan-400",
  Turborepo: "border-slate-300/25 bg-slate-300/10 text-slate-200",
  Monorepo: "border-purple-400/25 bg-purple-400/10 text-purple-300",
  WebSocket: "border-emerald-500/25 bg-emerald-500/10 text-emerald-400",
  "Socket.io": "border-teal-500/25 bg-teal-500/10 text-teal-400",
  Redis: "border-red-500/25 bg-red-500/10 text-red-400",
};
